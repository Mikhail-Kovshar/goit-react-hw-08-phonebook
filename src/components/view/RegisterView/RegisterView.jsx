  ...
  return (
    <>
      <div className={s.formPage}>
        <div>
          <h1 className={s.title}>Зареєструйтесь</h1>
          <div className={s.massage}>
            {isNameEmpty && <p>Заповніть поле name</p>}
            {isEmailEmpty && <p>Заповніть поле email</p>}
            {isPasswordEmpty && <p>Заповніть поле password</p>}
            {!isPasswordValid && (
        ...
        <form className={s.form} onSubmit={handleSubmit} autoComplete="off">
          <p className={s.formText}> Введіть наступні данні</p>
